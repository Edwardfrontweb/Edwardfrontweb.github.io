...
const Myswiper2 = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-2', {
  slidesPerView: 3,
  spaceBetween: 30,
  pagination: {
...
const MySwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-1', {
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  resizableSwiper('(max-width: 900px)', '.slider-2', {
    loop: true,
    spaceBetween: 30,
    slidesPerView: 1
  }, someFunc);
  resizableSwiper('(max-width: 1330px)', '.slider-2', {
    loop: true,
    spaceBetween: 30,
    slidesPerView: 2
  }, someFunc);
  ...
  resizableSwiper('(max-width: 700px)', '.slider-3', {
    loop: true,
    spaceBetween: 20,
    slidesPerView: 1
  }, someFunc);
  resizableSwiper('(max-width: 900px)', '.slider-3', {
    loop: true,
    spaceBetween: 20,
    slidesPerView: 2
  }, someFunc);
  resizableSwiper('(max-width: 1330px)', '.slider-3', {
    loop: true,
    spaceBetween: 30,
    slidesPerView: 3
  }, someFunc);
  resizableSwiper('(max-width: 1500px)', '.slider-3', {
    loop: true,
    spaceBetween: 10,
    slidesPerView: 3,
    freeMode: true,
  ...
  resizableSwiper('(min-width: 1501px)', '.slider-3', {
    loop: true,
    spaceBetween: 10,
    slidesPerView: 6,
    freeMode: true,
...
const rules1 = [{
  ...
  rules: [{
    rule: "minLength",
    value: 2,
    errorMessage: "Необходимо больше знаков"
  }, {
    rule: "required",
    value: true,
  ...
  ruleSelector: ".input-brand",
  rules: [{
    rule: "required",
    value: true,
    errorMessage: "Заполните марку машины!"
  }]
}, {
  ruleSelector: ".input-model",
  rules: [{
    rule: "required",
    value: true,
    errorMessage: "Укажите модель автомобиля!"
  }]
}, {
  ruleSelector: ".input-country",
  rules: [{
    rule: "required",
    value: true,
...
(0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)(".form-1", rules1, afterForm);
